...
<head>
  ...
  <style>
    .hero { background: linear-gradient(135deg,#17a2b8 0%, #6610f2 100%); color:#fff; border-radius:.5rem; }
    .hero .lead{opacity:.9}
  </style>
  </head>
<body class="bg-light">
  ...
  <main class="container my-4">
    <div class="hero p-4 mb-4 shadow-sm">
      ...
      <p class="lead mb-0">Manage users and orders with full admin access.</p>
    </div>
      ...
      <div class="col-md-6 mb-3">
        <div class="card h-100 shadow-sm">
          <div class="card-body d-flex flex-column">
            ...
            <p class="text-muted">Create, view, edit, and delete users. Add money to wallets.</p>
            <div class="mt-auto">
              <a class="btn btn-info mr-2" href="{{ route('admin.users.index') }}">Manage Users</a>
              <a class="btn btn-outline-info" href="{{ route('admin.users.create') }}">Create User</a>
            </div>
          </div>
        </div>
      </div>
      <div class="col-md-6 mb-3">
        <div class="card h-100 shadow-sm">
          <div class="card-body d-flex flex-column">
            ...
            <p class="text-muted">Review and process user orders.</p>
            <div class="mt-auto">
