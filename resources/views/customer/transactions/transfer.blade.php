...
<body class="bg-light">
  ...
  <main class="container my-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <a href="{{ route('customer.transactions.index') }}" class="btn btn-sm btn-outline-secondary">Back to Transactions</a>
    </div>
    ...
    <div class="card shadow-sm">
      <div class="card-body">
        <form method="POST" action="{{ route('customer.transactions.transfer') }}">
          @csrf
          <div class="form-row">
            ...
            <div class="form-group col-md-12">
              ...
              <input type="text" class="form-control" name="description" id="description" value="{{ old('description') }}" required maxlength="255">
            </div>
          </div>
